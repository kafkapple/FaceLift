...
BODY_PARTS: dict[str, list[int]] = dict(_mouse.body_parts)
BODY_PART_COLORS: dict[str, str] = dict(_mouse.body_part_colors)
MOUSE_ABLATION_TIERS: dict[str, list[int]] = dict(_mouse.ablation_tiers)
...
RAT_BODY_PARTS: dict[str, list[int]] = dict(_rat.body_parts)
RAT_BODY_PART_COLORS: dict[str, str] = dict(_rat.body_part_colors)
RAT_ABLATION_TIERS: dict[str, list[int]] = dict(_rat.ablation_tiers)
