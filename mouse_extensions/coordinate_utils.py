...
SSOT for all coordinate transformations in the FaceLift mouse project.
...
See also:
    - mouse_extensions/docs/COORDINATE_SYSTEMS.md (theory + debugging history)
    - mouse_extensions/docs/DATASET_FRAME_INDEXING.md (frame indexing + coords)
"""

import numpy as np

# M5 dataset scene parameters (from preprocessing)
# Derived from 6-camera rig: centroid of camera positions and average distance
