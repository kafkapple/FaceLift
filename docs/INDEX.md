...
>
> **Obsidian (이론/논문/NeurIPS 전략)**: `~/Documents/Obsidian/30_Projects/_CODES/FaceLift/docs/` — [[INDEX v7.0]]
> - `neurips/`: 논문 초안, Gap 분석, 프로젝트 종합, Executive Summary
> - `theory/`: 좌표계, Stage1/2, Loss 수식
> - `_Notes/`: 23개 연구 노트 (260114~260317)
...
> See: [[_archive/phase1_experiments/mvdiffusion_bottleneck_analysis]] §5

### specs/ (기술 사양, 구 theory/)

| 문서 | 내용 |
|------|------|
| **[[PIPELINE_ARCHITECTURE]]** | 2-stage 파이프라인 사양 (MVDiff + GS-LRM I/O, config) |
| **[[MAMMAL_MESH_RENDERING_PIPELINE]]** | MAMMAL mesh rendering 3단계 사양 |
| [[METRICS_PROTOCOL]] | 평가 메트릭 프로토콜 (White-BG, FG-only) |

> **이론 문서 → Obsidian으로 이동** (2026-03-17):
> - MULTIVIEW_DIFFUSION_THEORY → `Obsidian/docs/theory/`
> - MV_ADAPTER_TECHNICAL → `Obsidian/docs/research/`
> - SLIDES_FACELIFT_PIPELINE → `Obsidian/Presentation/`
...
> See: [[experiments/fl_vs_ps_comparison]] + [[_archive/phase1_experiments/mvdiffusion_bottleneck_analysis]] + [[_archive/phase1_experiments/E2E_EXPERIMENT_ANALYSIS]]
...
| **H_T1: Dist. Mismatch** | **🔬 Testing (DA1)** | [[_archive/phase1_experiments/mvdiffusion_bottleneck_analysis]] §5 |
...
**중복 금지**: 동일 내용을 양쪽에 두지 않음. 참조 시 포인터만 남김.

### Obsidian 경로 (`~/Documents/Obsidian/30_Projects/_CODES/FaceLift/`)

| 경로 | 내용 |
|------|------|
| `docs/INDEX.md` (v7.0) | Obsidian 전체 문서 인덱스 |
| `docs/neurips/` | 논문 초안, NeurIPS Gap 분석, Executive Summary, 프로젝트 종합 |
