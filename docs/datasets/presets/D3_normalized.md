...
| 요인 | 기여 | 근거 |
|------|------|------|
| **Coverage ~6%** | +6 PSNR | D7_1(~3%)→D3(~6%) = 20.9→27.1 |
...
|----------|----------|-----|-----|----------|------|
| **D3_normalized** | **~6%** | 256 | 549 | **27.09** | - |
| D7_1 | ~3% | 256 | 549 | 20.93 | -6.16 |
| D8 | ~3% | 256 | 549 | 20.21 | -6.88 |
| M3_norm | ~6% | 가변 | 549 | 17.09 | -10.00 |
| M3_persample | ~3% | 256 | 549 | 17.08 | -10.01 |
...
|------|------|-------------------|
| **H1** | Coverage↑ → PSNR↑ | ~6% Coverage = 27 PSNR |
