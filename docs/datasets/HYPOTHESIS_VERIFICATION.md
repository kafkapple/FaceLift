...
| 가설 | 설명 | 검증 방법 | 상태 |
|------|------|-----------|------|
| **H1** | Coverage↑ → PSNR↑ | D7_1 (~3%) vs D3 (~6%) | ✅ 검증됨 |
...
|----------|----------|-----|-----|----------|------|
| D7_1 | ~3% | 549 | 256 | 20.93 | 기준 |
| D3_normalized | **~6%** | 549 | 256 | **27.09** | +6.16 |
| M3_norm | ~6% | 549 | 가변 | 17.09 | PP 문제 |

**결론**: ✅ Coverage ~3% → ~6%로 **+6 PSNR** (PP 정합 필요)
...
|----------|-----|-----|----------|-----------|----------|
| M3_norm | **가변** | 549 | ~6% | 13.62° | 17.09 |
| M3_persample (deprecated) | **가변** | 549 | ~3% | 16.15° | 17.08 |
| **M3_1** | **256** | 549 | ~6% | 0° | TBD |
| **M3_2** | **256** | 549 | ~6% | 0° | TBD ⭐ |
...
**상세 분석**: [[VIEW_SELECTION_ANALYSIS]] (코드 분석, 진단 도구, 실험 권장)
