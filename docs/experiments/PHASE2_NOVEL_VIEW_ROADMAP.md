...
| [[DIFIX_STRATEGY]] | DiFix 3D+ 2.5-stage training strategy |
...
## Novel View Quality Strategy

> Consolidated from NOVEL_VIEW_QUALITY_STRATEGY.md (260331 audit)
...
| 구성 요소 | 경로 | 상태 |
|-----------|------|:----:|
| Training Strategy | `docs/experiments/DIFIX_STRATEGY.md` | PLANNING |
