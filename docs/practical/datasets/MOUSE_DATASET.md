...
> Train 먼저 처리 후 Val 생성

---

## 8. Camera Configuration (6 Views)
...
|------|-----|
| **평균 Elevation** | 19.2° |
| **Outlier** | View 5 (elevation 30.8°, +11.6° 이탈) |

> ⚠️ **View 5 주의**: Elevation이 평균에서 크게 벗어남 (z-score = 1.54)
